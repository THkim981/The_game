...
// .wrangler/tmp/pages-oPGLE2/functionsWorker-0.13748876034046043.mjs
...
__name2(isPreflight, "isPreflight");
...
__name2(ensureProfile, "ensureProfile");
...
__name2(defaultStats, "defaultStats");
...
__name2(upsertStats, "upsertStats");
...
__name2(upsertBestTime, "upsertBestTime");
...
__name2(addSnapshot, "addSnapshot");
...
__name2(getSnapshots, "getSnapshots");
...
__name2(resetProfile, "resetProfile");
...
__name2(upsertAnonBestScore, "upsertAnonBestScore");
...
__name2(getAnonRanking, "getAnonRanking");
...
var onRequest4 = /* @__PURE__ */ __name2(async ({ request, env, params }) => {
  if (isPreflight(request)) return new Response(null, { status: 204 });
...
__name(getAnonRanking2, "getAnonRanking2");
__name2(getAnonRanking2, "getAnonRanking");
...
__name(sanitizeAnonUserId2, "sanitizeAnonUserId2");
__name2(sanitizeAnonUserId2, "sanitizeAnonUserId");
...
__name(upsertAnonBestScore2, "upsertAnonBestScore2");
__name2(upsertAnonBestScore2, "upsertAnonBestScore");
...
// .wrangler/tmp/bundle-XAJVoo/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-XAJVoo/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.13748876034046043.js.map
